...
! ------------------------------------------------------------------------------  
! File created at 17:31 on 26.7.2016   
! ----------------------------------------------------------------------  
 
 
Module InputOutput_SimplifiedDMIDM 
...
If (i_c.Eq.0) mEt2Input= Cmplx(wert,Aimag(mEt2Input),dp) 
If (i_c.Eq.1) mEt2Input= Cmplx(Real(mEt2Input,dp),wert,dp) 
Else
...
Complex(dp) :: PDGhh,PDGAh,PDGHp,PDGetR,PDGetI,PDGetp,PDGVP,PDGVZ,PDGVWp,PDGVG,PDGgP,PDGgWp,         & 
...
Character(len=30) :: NameParticleetR
Character(len=30) :: NameParticleetI
Character(len=30) :: NameParticleetp
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - SimplifiedDM/IDM Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 6, Real(mEt2Input,dp) ,"# mEt2Input"
...
If (Abs(Aimag(mEt2Input)).gt.0._dp) WriteNextBlock = .True. 
...
End if 
If (Abs(Aimag(mEt2Input)).gt.0._dp) Then 
Write(io_L,101) 6, Aimag(mEt2Input) ,"# mEt2Input"
End if 
End if 
...
Write(io_L,104) 3,Real(lam2,dp), "# lam2" 
...
Write(io_L,104) 1,Real(mEt2,dp), "# mEt2" 
If (Abs(Aimag(mEt2)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMHDM Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Aimag(lam1), "# lam1" 
Write(io_L,104) 3,Aimag(lam2), "# lam2" 
Write(io_L,104) 5,Aimag(lam4), "# lam4" 
Write(io_L,104) 4,Aimag(lam3), "# lam3" 
Write(io_L,104) 1,Aimag(mEt2), "# mEt2" 
End if 
WriteNextBlock = .false. 
...
Write(io_L,104) 3,Aimag(mH21L), "# mH2" 
End if 
Else 
WriteNextBlock = .false. 
Write(io_L,106) "Block TREESM Q=",Q,"# (Renormalization Scale)" 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,10:144)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,10:144)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If(0..gt.MinWidth) Then 
Write(io_L,200) INT(PDGFv(1)),0.,Trim(NameParticleFv(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
End if 
If(0..gt.MinWidth) Then 
Write(io_L,200) INT(PDGFv(2)),0.,Trim(NameParticleFv(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
End if 
If(0..gt.MinWidth) Then 
Write(io_L,200) INT(PDGFv(3)),0.,Trim(NameParticleFv(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
...
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(1) = PDGetR 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleetR)//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
If (BRVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGetp 
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRVZ(1,icount).Gt.BrMin) Then 
...
If(gTVWp.gt.MinWidth) Then 
Write(io_L,200) INT(PDGVWp),gTVWp,Trim(NameParticleVWp) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRVWp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetp 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
If (BRVWp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetR 
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleetR)//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
CurrentPDG2(2) = PDGFu(gt2) 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
If (BRVWp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVWp 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleVWp)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
icount = icount +1 
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleetI)//" "//")"
If (((gTetI.le.WidthToBeInvisible).and.(gTetI.le.WidthToBeInvisible)).OR. & 
...
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetR 
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleetR)//" "//Trim(NameParticleetR)//" "//")"
If (((gTetR.le.WidthToBeInvisible).and.(gTetR.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(1) = BRinvH(1)+BRhh(1,icount) 
End if 
End if 
...
If(gTetR.gt.MinWidth) Then 
Write(io_L,200) INT(PDGetR),gTetR,Trim(NameParticleetR) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRetR(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRetR(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetp 
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRetR(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleVWp)//"^* "//")"
Write(io_L,201) BRetR(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGetR 
Write(io_L,201) BRetR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetR)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleetR)//" "//")"
End if 
icount = icount +1 
End if 
...
If(gTetI.gt.MinWidth) Then 
Write(io_L,200) INT(PDGetI),gTetI,Trim(NameParticleetI) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGhh 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetp 
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRetI(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleVWp)//"^* "//")"
Write(io_L,201) BRetI(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetp)//"^* "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetR)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
If(gTetp.gt.MinWidth) Then 
Write(io_L,200) INT(PDGetp),gTetp,Trim(NameParticleetp) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BRetp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
If (BRetp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGhh 
CurrentPDG2(2) = PDGetp 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleetp)//" "//")"
End if 
icount = icount +1 
If (BRetp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetp 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleetp)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRetp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetR 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRetp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetp)//" -> "//Trim(NameParticleetR)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SimplifiedDMIDM",status="unknown")
...
Write(123,*) "MetR= ", Abs(MetR) 
Write(123,*) "MetI= ", Abs(MetI) 
Write(123,*) "Metp= ", Abs(Metp) 
...
Write(123,*) "WWp = ",gTVWp
Write(123,*) "Wh = ",gThh
Write(123,*) "WetR = ",gTetR
Write(123,*) "WetI = ",gTetI
Write(123,*) "" 
Write(123,*) "" 
...
If (i_c.Eq.0) mEt2IN= Cmplx(wert,Aimag(mEt2IN),dp) 
If (i_c.Eq.1) mEt2IN= Cmplx(Real(mEt2IN,dp),wert,dp) 
InputValueformEt2= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.3) Then 
If (i_c.Eq.0) mH2IN= Cmplx(wert,Aimag(mH2IN),dp) 
If (i_c.Eq.1) mH2IN= Cmplx(Real(mH2IN,dp),wert,dp) 
InputValueformH2= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
...
End Module InputOutput_SimplifiedDMIDM 
