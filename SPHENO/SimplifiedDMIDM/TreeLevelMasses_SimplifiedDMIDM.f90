...
Module TreeLevelMasses_SimplifiedDMIDM 
...
Subroutine TreeMasses(MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd,MFd2,             & 
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,            & 
& ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,GenerationMixing,kont)
...
Real(dp),Intent(out) :: MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd(3),MFd2(3),MFe(3),MFe2(3),              & 
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesSimplifiedDM/IDM'
...
Metp2 = mEt2 + (lam3*v**2)/2._dp 
  If (Metp2.ne.Metp2) Then 
      ...
      Call TerminateProgram 
    End If 
  If (Metp2.Ge.0._dp) Then 
Metp = sqrt(Metp2) 
  Else 
    If (ErrorLevel.Ge.0) Then 
      Write(10,*) 'Warning from Metp2' 
      Write(10,*) 'mass squarred is negative: ',Metp2 
    End If 
     Write(ErrCan,*) 'Warning from routine Metp2' 
     Write(ErrCan,*) 'in the calculation of the masses' 
     Write(ErrCan,*) 'occurred a negative mass squared!' 
     Write(ErrCan,*) Metp2 
     Write(*,*) 'Warning from routine Metp2' 
     Write(*,*) 'in the calculation of the masses' 
     Write(*,*) 'occurred a negative mass squared!' 
     Write(*,*) Metp2 
        Metp= 1._dp 
...
MetR2 = (2._dp*(mEt2) + (lam3 + lam4 + lam5)*v**2)/2._dp 
  If (MetR2.ne.MetR2) Then 
      ...
      Call TerminateProgram 
    End If 
  If (MetR2.Ge.0._dp) Then 
MetR = sqrt(MetR2) 
  Else 
    If (ErrorLevel.Ge.0) Then 
      Write(10,*) 'Warning from MetR2' 
      Write(10,*) 'mass squarred is negative: ',MetR2 
    End If 
     Write(ErrCan,*) 'Warning from routine MetR2' 
     Write(ErrCan,*) 'in the calculation of the masses' 
     Write(ErrCan,*) 'occurred a negative mass squared!' 
     Write(ErrCan,*) MetR2 
     Write(*,*) 'Warning from routine MetR2' 
     Write(*,*) 'in the calculation of the masses' 
     Write(*,*) 'occurred a negative mass squared!' 
     Write(*,*) MetR2 
        MetR= 1._dp 
...
& v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,kont)
...
Subroutine TreeMassesEffPot(MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,           & 
...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,               & 
& Yd,Ye,mH2,mEt2,GenerationMixing,kont)
...
Subroutine SortGoldstones(MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
...
End Module TreeLevelMasses_SimplifiedDMIDM 
