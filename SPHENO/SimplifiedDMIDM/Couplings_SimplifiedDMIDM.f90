...
! ------------------------------------------------------------------------------  
! File created at 17:30 on 26.7.2016   
! ----------------------------------------------------------------------  
 
 
Module Couplings_SimplifiedDMIDM
...
& Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,cplAhAhhh,cplAhetIetR,cpletIetIhh,cpletIetpcHp,       & 
& cpletIHpcetp,cpletpetRcHp,cpletphhcetp,cpletRetRhh,cpletRHpcetp,cplhhhhhh,             & 
& cplhhHpcHp,cplAhAhAhAh,cplAhAhetIetI,cplAhAhetpcetp,cplAhAhetRetR,cplAhAhhhhh,         & 
& cplAhAhHpcHp,cplAhetIetpcHp,cplAhetIetRhh,cplAhetIHpcetp,cplAhetpetRcHp,               & 
...
& ZEL,ZER,Yu,ZUL,ZUR,cplAhAhhh,cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIHpcetp,        & 
...
& ZER,Yu,ZUL,ZUR,cplAhAhhh,cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIHpcetp,            & 
& cpletpetRcHp,cpletphhcetp,cpletRetRhh,cpletRHpcetp,cplhhhhhh,cplhhHpcHp,               & 
...
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFuVGL,cplcFuFuVGR)
...
& ZEL,ZER,lam4,lam5,v,lam1,lam3,lam2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,             & 
...
& cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,cpletIHpcetp,cpletIcetpVWp,cpletphhcetp,     & 
...
& cpletpcetpVZVZ,cplAhAhhh,cplAhetIetR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWpgWpAh,cplcgWCgWCAh,cplAhhhVZ,               & 
& cplAhHpcVWp,cplAhAhAhAh,cplAhAhetIetI,cplAhAhetRetR,cplAhAhhhhh,cplAhAhcVWpVWp,        & 
& cplAhAhVZVZ,cpletIetIhh,cpletRetRhh,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,               & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,cplcgWCgWChh,cplcgZgZhh,              & 
& cplhhhhhh,cplhhHpcVWp,cplhhcVWpVWp,cplhhVZVZ,cpletIetIhhhh,cpletRetRhhhh,              & 
& cplhhhhhhhh,cplhhhhcVWpVWp,cplhhhhVZVZ,cpletIetpcVWp,cpletIetRVZ,cpletIetIetIetI,      & 
& cpletIetIetRetR,cpletIetIcVWpVWp,cpletIetIVZVZ,cpletpetRcVWp,cpletRetRetRetR,          & 
...
Implicit None 
Real(dp), Intent(in) :: g3,g1,g2,TW,lam5,v
...
& cplAhcHpVWp,cpletIetpcHp,cpletpetRcHp,cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),             & 
...
& cplHpHpcHpcHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,cpletIHpcetp,cpletIcetpVWp,    & 
& cpletphhcetp,cpletpcetpVP,cpletpcetpVZ,cpletRHpcetp,cpletRcetpVWp,cplAhAhetpcetp,      & 
& cpletIetIetpcetp,cpletpetpcetpcetp,cpletpetRetRcetp,cpletphhhhcetp,cpletpcetpVPVP,     & 
& cpletpcetpcVWpVWp,cpletpcetpVZVZ,cplAhAhhh,cplAhetIetR,cplcFdFdAhL(3,3),               & 
& cplcFdFdAhR(3,3),cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),  & 
& cplcgWpgWpAh,cplcgWCgWCAh,cplAhhhVZ,cplAhHpcVWp,cplAhAhAhAh,cplAhAhetIetI,             & 
& cplAhAhetRetR,cplAhAhhhhh,cplAhAhcVWpVWp,cplAhAhVZVZ,cpletIetIhh,cpletRetRhh,          & 
& cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFuFuhhL(3,3),  & 
& cplcFuFuhhR(3,3),cplcgWpgWphh,cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcVWp,           & 
& cplhhcVWpVWp,cplhhVZVZ,cpletIetIhhhh,cpletRetRhhhh,cplhhhhhhhh,cplhhhhcVWpVWp,         & 
& cplhhhhVZVZ,cpletIetpcVWp,cpletIetRVZ,cpletIetIetIetI,cpletIetIetRetR,cpletIetIcVWpVWp,& 
...
Subroutine CouplingsForTadpoles(Yd,ZDL,ZDR,Yu,ZUL,ZUR,Ye,ZEL,ZER,lam4,lam5,           & 
& v,lam1,g2,lam3,lam2,g1,TW,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFuFuhhL,cplcUFuFuhhR,         & 
& cplcUFeFehhL,cplcUFeFehhR,cpletpetRcHp,cplhhHpcHp,cplhhcHpVWp,cpletRetRHpcHp,          & 
& cplhhhhHpcHp,cpletphhcetp,cpletRHpcetp,cpletRcetpVWp,cpletpetRetRcetp,cpletphhhhcetp,  & 
...
& cpletIetRVZ,cpletIetIetRetR,cpletpetRcVWp,cpletRetRetRetR,cpletRetRcVWpVWp,            & 
& cpletRetRVZVZ)
...
& cplhhhhhhhh,cplhhhhcVWpVWp,cplhhhhVZVZ,cpletIetRVZ,cpletIetIetRetR,cpletpetRcVWp,      & 
& cpletRetRetRetR,cpletRetRcVWpVWp,cpletRetRVZVZ
...
End Module Couplings_SimplifiedDMIDM 
