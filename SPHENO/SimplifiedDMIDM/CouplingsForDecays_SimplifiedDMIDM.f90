...
Module CouplingsForDecays_SimplifiedDMIDM
...
& MetI2input,Metpinput,Metp2input,MetRinput,MetR2input,MFdinput,MFd2input,               & 
& MFeinput,MFe2input,MFuinput,MFu2input,Mhhinput,Mhh2input,MHpinput,MHp2input,           & 
& MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,            & 
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,        & 
& cplcFuFuVZR,deltaM)
...
Complex(dp),Intent(in) :: lam1input,lam2input,lam4input,lam3input,Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),       & 
& mH2input,mEt2input

Real(dp),Intent(in) :: MAhinput,MAh2input,MetIinput,MetI2input,Metpinput,Metp2input,MetRinput,               & 
& MetR2input,MFdinput(3),MFd2input(3),MFeinput(3),MFe2input(3),MFuinput(3),              & 
...
& ZUL,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,.True.,kont)
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,        & 
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,        & 
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cpletIetRVZ,cpletpcetpVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,         & 
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cpletIetpcVWp,cpletpetRcVWp,cplcFdFucVWpL,cplcFdFucVWpR,              & 
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,cpletIetIhh,      & 
...
Subroutine CouplingsFor_etR_decays_2B(m_in,i1,MAhinput,MAh2input,MetIinput,           & 
& MetI2input,Metpinput,Metp2input,MetRinput,MetR2input,MFdinput,MFd2input,               & 
& MFeinput,MFe2input,MFuinput,MFu2input,Mhhinput,Mhh2input,MHpinput,MHp2input,           & 
& MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,ZURinput,            & 
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cpletIetRVZ,cpletpetRcVWp,cpletRetRhh,deltaM)
...
Complex(dp),Intent(out) :: cpletIetRVZ,cpletpetRcVWp,cpletRetRhh
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cpletIetIhh,cpletIetpcVWp,cpletIetRVZ,deltaM)
...
Complex(dp),Intent(out) :: cpletIetIhh,cpletIetpcVWp,cpletIetRVZ
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cpletIcetpVWp,cpletphhcetp,cpletpcetpVZ,cpletRcetpVWp,deltaM)
...
Complex(dp),Intent(out) :: cpletIcetpVWp,cpletphhcetp,cpletpcetpVZ,cpletRcetpVWp
...
& ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,lam1input,          & 
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,          & 
...
End Module CouplingsForDecays_SimplifiedDMIDM
