...
& vinput,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,v,CKMout,sinW2_out,         & 
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(71), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG71(g1input,g2input,g3input,lam1input,lam2input,lam4input,           & 
& lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,mEt2input,vinput,g1D)

Call GToParameters71(g1D,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,v)
...
End Module RunSM_SimplifiedDMIDM 
