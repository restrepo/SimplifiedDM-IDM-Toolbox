...
Module Fu3Decays_SimplifiedDMIDM 
...
Subroutine FuThreeBodyDecay(n_in,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,           & 
...
& mEt2,v,gThh,gTVWp,gTVZ,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,gFuFucFvFv,         & 
...
End Module Fu3Decays_SimplifiedDMIDM 
