...
Module Fd3Decays_SimplifiedDMIDM 
...
Subroutine FdThreeBodyDecay(n_in,MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,           & 
...
& mEt2,v,gThh,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdcFvFv,gFdFucFvFe,         & 
...
Call CouplingsFor_Fd_decays_3B(MFd(i_run),i_run,MAh,MAh2,MetI,MetI2,Metp,             & 
...
& Yu,Yd,Ye,mH2,mEt2,v,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,     & 
...
End Module Fd3Decays_SimplifiedDMIDM 
