...
! ------------------------------------------------------------------------------  
! File created at 17:32 on 26.7.2016   
! ----------------------------------------------------------------------  
 
 
Program SPhenoSimplifiedDMIDM 
 
Use Control
Use InputOutput_SimplifiedDMIDM
Use LoopFunctions
Use RunSM_SimplifiedDMIDM
Use LowEnergy_SimplifiedDMIDM
Use FlavorKit_LFV_SimplifiedDMIDM
Use FlavorKit_QFV_SimplifiedDMIDM
Use FlavorKit_Observables_SimplifiedDMIDM
Use Mathematics
Use Model_Data_SimplifiedDMIDM
Use Tadpoles_SimplifiedDMIDM 
 Use HiggsCS_SimplifiedDMIDM
Use TreeLevelMasses_SimplifiedDMIDM
Use LoopMasses_SimplifiedDMIDM
 
Use BranchingRatios_SimplifiedDMIDM
...
Call OneLoopMasses(MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd,MFd2,MFe,            & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,            & 
& ZUL,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,kont)
...
& Metp,Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,               & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,lam1,lam2,lam4,             & 
& lam3,lam5,Yu,Yd,Ye,mH2,mEt2,gPFu,gTFu,BRFu,gPFe,gTFe,BRFe,gPFd,gTFd,BRFd,              & 
& gPFv,gTFv,BRFv,gPVZ,gTVZ,BRVZ,gPVWp,gTVWp,BRVWp,gPhh,gThh,BRhh,gPetR,gTetR,            & 
& BRetR,gPetI,gTetI,BRetI,gPetp,gTetp,BRetp)

End If 
 
 If (CalculateLowEnergy) then 
Call CalculateLowEnergyConstraints(g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,              & 
& Yd,Ye,mH2,mEt2,v,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,            & 
...
If (OutputForMO) Then 
Call RunningFermionMasses(MFe,MFe2,MFd,MFd2,MFu,MFu2,v,g1,g2,g3,lam1,lam2,            & 
& lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,kont)
...
& lam2input,lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,              & 
& mEt2input,vinput,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,            & 
& BrDmunu,ratioDmunu,BrDsmunu,ratioDsmunu,BrDstaunu,ratioDstaunu,BrBmunu,ratioBmunu,     & 
& BrBtaunu,ratioBtaunu,BrKmunu,ratioKmunu,RK,RKSM,muEgamma,tauEgamma,tauMuGamma,         & 
& CRmuEAl,CRmuETi,CRmuESr,CRmuESb,CRmuEAu,CRmuEPb,BRmuTo3e,BRtauTo3e,BRtauTo3mu,         & 
& BRtauToemumu,BRtauTomuee,BRtauToemumu2,BRtauTomuee2,BrZtoMuE,BrZtoTauE,BrZtoTauMu,     & 
...
Complex(dp),Intent(inout) :: lam1input,lam2input,lam4input,lam3input,Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),       & 
& mH2input,mEt2input

Real(dp) :: MAh,MAh2,MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd(3),MFd2(3),MFe(3),MFe2(3),              & 
...
Complex(dp) :: lam1,lam2,lam4,lam3,Yu(3,3),Yd(3,3),Ye(3,3),mH2,mEt2
...
& cplcFvFeVWpL(3,3),cplcFvFeVWpR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgAgWpcVWp,   & 
...
& cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cpletIcetpVWp,cpletIetIcVWpVWp,cpletIetIhh,            & 
& cpletIetIVZVZ,cpletIetpcHp,cpletIetpcVWp,cpletIetRVZ,cpletIHpcetp,cpletpcetpcVWpVWp,   & 
& cpletpcetpVP,cpletpcetpVZ,cpletpcetpVZVZ,cpletpetRcHp,cpletpetRcVWp,cpletphhcetp,      & 
& cpletRcetpVWp,cpletRetRcVWpVWp,cpletRetRhh,cpletRetRVZVZ,cpletRHpcetp,cplhhcHpVWp,     & 
& cplhhcVWpVWp,cplhhhhcVWpVWp,cplhhhhhh,cplhhhhVZVZ,cplhhHpcHp,cplhhHpcVWp,              & 
& cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZVZ,cplHpcVWpVP,              & 
...
& TVO4dTLRcheck(3,3,3,3),TVO4dTRLcheck(3,3,3,3),TVO4dTRRcheck(3,3,3,3),OAh2qSLcheck(3,3,1),& 
& OAh2qSRcheck(3,3,1),TSOdulvSLLcheck(3,3,3,3),TSOdulvSRRcheck(3,3,3,3),TSOdulvSRLcheck(3,3,3,3)
...
& OA2qVRcheck(3,3),OG2qSLcheck(3,3),OG2qSRcheck(3,3),OH2qSLcheck(3,3,1),OH2qSRcheck(3,3,1)
...
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,mEt2input,              & 
& vinput,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,v,CKM_160,sinW2_160,        & 
...
& Yu,ZUL,ZUR,cplAhAhhh,cplAhetIetR,cpletIetIhh,cpletIetpcHp,cpletIHpcetp,cpletpetRcHp,   & 
...
& lam4input,lam3input,lam5input,Yuinput,Ydinput,Yeinput,mH2input,mEt2input,              & 
& vinput,g1,g2,g3,lam1,lam2,lam4,lam3,lam5,Yu,Yd,Ye,mH2,mEt2,v,CKM_MZ,sinW2_MZ,          & 
...
& MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhcVWpVWp,cplAhAhVZVZ,             & 
...
& cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cpletIetIcVWpVWp,cpletIetIVZVZ,        & 
& cpletIetpcVWp,cpletIetRVZ,cpletpcetpcVWpVWp,cpletpcetpVZ,cpletpcetpVZVZ,               & 
& cpletpetRcVWp,cpletRetRcVWpVWp,cpletRetRVZVZ,cplhhcVWpVWp,cplhhhhcVWpVWp,              & 
...
End Program SPhenoSimplifiedDMIDM 
